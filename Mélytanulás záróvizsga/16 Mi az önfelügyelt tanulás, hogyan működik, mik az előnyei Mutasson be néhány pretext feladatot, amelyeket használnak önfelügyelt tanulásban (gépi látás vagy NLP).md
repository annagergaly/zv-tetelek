...
- NLP [link](https://amitness.com/posts/self-supervised-learning-nlp) példa:
	...
	- Next Sentence Prediction: Két mondatot kap a modell (elválasztva egy speciális tokennel), a feladata eldönteni, hogy a két mondat egymást követi-e. BERT előtanításához használták.
